...
def plot_skynoise(ax, times, sky, xlim=None, xticks=None):
    ...
    width = bb.width
    pos = [x0, y0, width, height]
    fig.text(pos[0] - .01, pos[1] + .004, r'$10^0$', ha='right', va='bottom',
             size=8)
    fig.text(pos[0] - .01, pos[1] + pos[3], r'$10^6$', ha='right', va='top',
             size=8)
...
def plot_searchnoise(ax, times, search, xlim=None, xticks=None,
    ...
    fig.text(pos[0] + pos[2] + .01, pos[1] + .004, r'$10^0$', ha='left',
             va='bottom', size=8)
    fig.text(pos[0] + pos[2] + .01, pos[1] + pos[3], r'$10^6$', ha='left',
             va='top', size=8)
