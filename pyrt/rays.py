...
class Rays2D(object):
    ...
    def read_file(self):
        ...
        ray_data_keys = [
            "ground_range", "group_range", "phase_path", "geometric_path_length", 
            "initial_elev", "final_elev", "apogee", "gnd_rng_to_apogee", "plasma_freq_at_apogee", 
            "virtual_height", "effective_range", "deviative_absorption", "TEC_path", "Doppler_shift",
            "Doppler_spread", "frequency", "nhops_attempted", "ray_label"
        ]
    ...
    def read_rays(event, rad, beam, cfg, folder, sim_fname):
        ...
        elvs = np.linspace(
            ...
            int((cfg.end_elevation-cfg.start_elevation)/cfg.elevation_inctiment)+1
        )
